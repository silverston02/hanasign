...
public class Exceptions {
    ...
    // 계약 관련 EXCEPTIONS
    public static final CustomException CONTRACT_NOT_FOUND = new CustomException(HttpStatus.NOT_FOUND, "30001", "계약을 찾을 수 없습니다");
    public static final CustomException SUPPLIER_NOT_FOUND = new CustomException(HttpStatus.NOT_FOUND, "30002", "계약을 찾을 수 없습니다");
    public static final CustomException CLIENT_NOT_FOUND = new CustomException(HttpStatus.NOT_FOUND, "30003", "계약을 찾을 수 없습니다");
    public static final CustomException CONTRACT_USER_NOT_FOUND = new CustomException(HttpStatus.BAD_REQUEST, "30004","사용자가 이 계약의 클라이언트나 공급자가 아닙니다.");
    ...
    public static final CustomException FILE_TRANS_ERROR = new CustomException(HttpStatus.INTERNAL_SERVER_ERROR, "31003", "파일 전송 중 오류가 발생했습니다"); //은석 추가
